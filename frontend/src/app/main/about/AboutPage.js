    ...
    return (
        <div className="flex flex-col flex-1 items-center justify-center p-16">
            <div className="w-full max-w-6xl text-center mb-20">
                ...
                >
                    <img className="mx-auto w-2/5 mb-20 animate-pulse" src="assets/images/logo/eregulation-light.svg" alt="logo" />
                    <Typography
                        variant="h1"
            ...
            <div className="fixed bottom-0 p-4 pb-20 text-center">
